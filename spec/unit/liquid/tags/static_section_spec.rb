...
describe Locomotive::Steam::Liquid::Tags::StaticSection do
  ...
  describe 'rendering' do
    ...
    context 'with site value' do
      ...
      it { is_expected.to eq 'Locomotive <div id="locomotive-section-header" class="locomotive-section my-awesome-header" data-locomotive-section-type="header">built by <strong data-locomotive-editor-setting="section-header.brand">Locomotive</strong></div>' }
