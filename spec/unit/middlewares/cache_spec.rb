...
describe Locomotive::Steam::Middlewares::Cache do
  ...
  describe 'the caching is enabled for the page' do
    ...
    context 'the request is a GET' do
      ...
      before { expect(cache).to receive(:read).with('e425b51c734ac5cbf9edb837c33cface').and_return(response) }

      context 'the cache is empty' do

        before { expect(cache).to receive(:write).with('e425b51c734ac5cbf9edb837c33cface', Marshal.dump([200, {}, ["Hello world!"]])) }
        ...
        describe 'ETag' do
          ...
          it { is_expected.to eq 'e425b51c734ac5cbf9edb837c33cface' }
    ...
    describe 'the page has not been modified for a while' do
      ...
      context 'based on the ETag' do
        ...
        let(:etag) { 'e425b51c734ac5cbf9edb837c33cface' }
